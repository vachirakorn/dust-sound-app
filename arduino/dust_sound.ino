...
// Arduino pin numbers.
const int sharpLEDPin = 0;   // Arduino digital pin
const int sharpVoPin = 36;   // Arduino analog pin
...
void send_sensor_value(float sensor_data){
  
  HTTPClient http;
  http.begin("http://13.251.118.114:3000/sensordata");
  http.addHeader("Content-Type", "application/json");
  String s_sensor_data = String(sensor_data, 4);
  Serial.println(s_sensor_data);
  String request = "{\"sensor_value\":\"" + s_sensor_data + "\"}"; 
